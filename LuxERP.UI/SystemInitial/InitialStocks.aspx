<%@ Page Title="门店与库存设备初始化" Language="C#" MasterPageFile="~/LuxERP.Master" AutoEventWireup="true" CodeBehind="InitialStocks.aspx.cs" Inherits="LuxERP.UI.SystemInitial.InitialStocks" %>
...
<script type="text/javascript">
  $(function () {
    menuSlide('#systemInitial', '#initialStocks');
    setDate();
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
     ...
     <div id="wrap" style=" width:800px">
       <div class="left">
         <asp:Label ID="Label1" runat="server" Text="仓库号或店铺号：" Width="100px"></asp:Label>         
       ...
       <div class="right">
         ...
         <asp:Label runat="server" ForeColor="Red" Text="请看清初始化设备所在"></asp:Label>
       </div>
       ...
       <div class="clear left">
         ...
         <asp:Label ID="Label15" runat="server" ForeColor="Red" Text="该设备新旧情况"></asp:Label>
       </div>       
