...
{
    public partial class RemoveStockFacility : System.Web.UI.Page
    {
        ...
        public void GVDataBind(int pageidx)
        {
            ...
            if (gvStock.HeaderRow != null)
            {
                ...
                gvStock.HeaderRow.Cells[12].Text = "<b>出库时间</b>";
        ...
        {
            DAL.StocksDAL.DelStocks(gvStock.DataKeys[e.RowIndex].Value.ToString());
            GVDataBind(1);
        }
