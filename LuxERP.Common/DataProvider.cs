...
namespace LuxERP.DAL.Common
{
    ...
    public class DataProvider
    {
        ...
        //private const string ConStr = "server=.;Database=LUXERP;User ID=sa;Password=iwooo2014;Max Pool Size = 512;";
        private const string ConStr = "server=10.15.123.110;Database=LUXERP;User ID=sa;Password=iwooo2014;Max Pool Size = 512;";
