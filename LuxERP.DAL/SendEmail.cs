...
namespace LuxERP.DAL
{
    public class SendEmail
    {
        ...
        public static bool SendMail(string Email, string MailServer, string EPassword, int MailServerPort, string MailTo, string MailToName, string MailTitle, string MailBody)
        {
            ...
            try
            {
                ...
                mm.From = new MailAddress(Email, "IIRIS系统邮件", Encoding.GetEncoding(936));
                //收件方看到的邮件来源；
                //第一个参数是发信人邮件地址
                //第二参数是发信人显示的名称
